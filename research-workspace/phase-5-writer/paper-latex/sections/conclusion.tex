...
dot-run sign negative) but not for wicket risk. Applying the Miller--Sanjurjo
streak-selection correction to cricket --- to our knowledge for the first time ---
we quantify the apparent-momentum illusion at $+0.121$: the naive $-0.114$ estimate
is almost exactly cancelled by a $-0.121$ finite-sequence bias, the corrected
estimate is $+0.007$, and no cell survives a state-stratified null, so the apparent
``cold hand'' is an artifact of the estimator.
