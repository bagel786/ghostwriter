...
we show the apparent death-over momentum is almost entirely a finite-sequence
artifact: the naive $-0.114$ estimate is matched by a $-0.121$ bias, the corrected
estimate is $+0.007$, and no cell survives a state-stratified null.
