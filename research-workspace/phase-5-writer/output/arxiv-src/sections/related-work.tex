...
gradient boosting and random forests \citep{raju2024dream11, hassan2025bpl},
...
\citep{huang2025momentum, wang2024momentum} has adopted permutation testing for
momentum. Cricket has its own hot-hand strand, but it does not use the
...
estimator. To our knowledge the streak-selection correction itself has not been
...
test the Markov assumption directly. And unlike all prior cricket work, we apply
the Miller--Sanjurjo correction --- with a state-stratified permutation null ---
to the question of per-ball momentum, the first such application in the sport.
